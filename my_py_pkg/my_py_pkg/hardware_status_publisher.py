...
# For VS code, I added 
# ~/ros2_ws/install/my_robot_interfaces/lib/python3.6/site-packages/my_robot_interfaces
# to the json file of VS code.
...
class HardwareStatusPublisherNode(Node): # MODIFY NAME
    def __init__(self):
        ...
        self.get_logger().info("Number status publisher has been started")
